...
# <h2>Communicate using Markdown</h2>
...
1. <h3>Open a new browser tab, and work on the steps in your second tab while you read the instructions in this tab.</h3>
